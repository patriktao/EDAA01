...
public class TurtleGraphics {
	 ...
	 * At start the turtle location is (0,0), the direction is north and he
	 * drawing pen is lowered.
	 * 
	 * @param g
	 *            the graphic object
	 */
	...
	/**
	 * The turtle moves to the location (newX,newY) and draws if the pen i
	 * lowered.
	 * 
	 * @param newX
	 *            the x coordinate of the new location
	 ...
	 * 
	 * @param n
	 *            the nbr of pixels to go forward
	 */
	...
	/**
	 * Lifts the turtles pen. / public void penUp() { isPenDown = false; }
	 * 
